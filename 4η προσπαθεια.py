...
class Test():
    ...
    def choose_test(self):
        ...
        self.epiloges1 = tk.Label(self.r,text="Αριθμός χωρίς το φαινόμενο Stroop: {}".format(self.no_stroop_number))
        self.epiloges2 = tk.Label(self.r,text="Αριθμός με το φαινόμενο Stroop: {}".format(self.yes_stroop_number))
        self.epiloges3 = tk.Label(self.r,text="Αριθμός προσπαθειών: {}".format(self.prospatheies))
        self.epiloges4 = tk.Label(self.r,text="Όριο χρόνου κάθε ερώτησης: {}".format(self.xronometro))
        ...
        self.end.grid(row = 13,columnspan = 2)

    def get_no_stroop_number(self,event):
        try:
            self.no_stroop_number = int(self.question_no_stroop.get())
            self.epiloges1.configure(text="Αριθμός χωρίς το φαινόμενο Stroop: {}".format(self.no_stroop_number))
            
        except:pass
    def get_yes_stroop_number(self,event):
        try:
            self.yes_stroop_number = int(self.question_yes_stroop.get())
            self.epiloges2.configure(text="Αριθμός με το φαινόμενο Stroop: {}".format(self.yes_stroop_number))
        except:pass
    def try_number(self,event):
        try:
            ...
            self.epiloges3.configure(text="Αριθμός προσπαθειών: {}".format(self.prospatheies))
    ...
    def no_timer(self):
        ...
        self.timer = 'no'
        self.xronometro ="Xωρίς χρονόμετρο"
        self.epiloges4.configure(text="Όριο χρόνου κάθε ερώτησης: {}".format(self.xronometro))
    def timer_input(self,event):
        if self.timer_choice_input.get().isnumeric:
            try:
                ...
                self.epiloges4.configure(text="Όριο χρόνου κάθε ερώτησης: {} δευτερόλεπτα".format(self.xronometro))
            except:pass
