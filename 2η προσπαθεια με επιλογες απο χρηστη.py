        ...
        with open('mycsv.csv','w',newline='') as f:
            ...
            for x in range(0,len(self.no_stroop)):
                if self.no_stroop[x] == 'Λάθος':
                    self.no_stroop.remove(self.no_stroop[x])
                    self.no_stroop.insert(x,'False')
                elif self.no_stroop[x] == 'Εκτός Χρόνου':
                    self.no_stroop.remove(self.no_stroop[x])
                    self.no_stroop.insert(x,'Time is up')
            for x in range(0,len(self.yes_stroop)):
                if self.yes_stroop[x] == 'Λάθος':
                    self.yes_stroop.remove(self.yes_stroop[x])
                    self.yes_stroop.insert(x,'False')
                elif self.yes_stroop[x] == 'Εκτός Χρόνου':
                    self.yes_stroop.remove(self.yes_stroop[x])
                    self.yes_stroop.insert(x,'Time is up')
